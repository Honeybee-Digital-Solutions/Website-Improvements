Phase 1: Entity-Specific Engines (Current)
We are building isolated logic for the four primary feed pillars to ensure every section of the UI is optimized for user relevance:
1. Posts Engine: Utilizes the User Embedding Matrix (Warm/Semi-Warm/Cold logic).
2. Events Engine: 
3. Listings Engine: 
4. Deals Engine: 
